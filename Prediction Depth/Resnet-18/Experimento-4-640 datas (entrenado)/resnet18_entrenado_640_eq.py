# -*- coding: utf-8 -*-
"""RESNET18-entrenado-640-eq.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1FmbKfvl1E8BgdjBxTW-tPSTUY9ucxK3K
"""
...
# Número de muestras
num_samples = 640 #Funciona correctamente con 750
...
import glob
idxs = np.random.choice(np.arange(len(subset_train_dataset)),640, replace = False) #Se sacan 1024 imagenes
...
df_high_accuracy_pd12 = df_depth_clase[df_depth_clase['Pred_depth'] == 12]
descripciones = df_high_accuracy_pd12['Descripcion']

Prediction_depth = 12

for i in range(0,10):
  mask = df_high_accuracy_pd12[df_high_accuracy_pd12['Clase'] == i]

  #Imganes correctamente clasificadas
  df_12_TRUE =  mask[mask['Pred'] == 'Correcto']
  df_12_FALSE = mask[mask['Pred'] == 'Incorrecto']
  idx_true = df_12_TRUE.index
  idx_false = df_12_FALSE.index

  largo_correcto = len(df_12_TRUE)
  largo_incorrecto = len(df_12_FALSE)
...
df_clases_cada_pd.to_csv('Dataframe_capas_pd_RESNET18-entrenado-640-eq.csv', index=False)
df_capas.to_csv('Dataframes_capas_pd_RESNET18-entrenado-640-eq.csv', index=False)